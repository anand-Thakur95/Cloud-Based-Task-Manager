...
const Users = () => {
  ...
  const { data: teamList, isLoading: isLoadingTeamList, error: errorTeamList, refetch } = useGetTeamListQuery();
    ...
    <>
      <div className="mt-16 w-full md:px-1 px-0 mb-6">
        <div className="flex items-center justify-between mb-8">
          ...
          <Button
            className="flex flex-row-reverse gap-1 items-center bg-blue-600 text-white rounded-md 2xl:py-2.5 hover:bg-blue-500"
            onClick={() => {
              setSelected(null); 
              setOpen(true);
            }}
